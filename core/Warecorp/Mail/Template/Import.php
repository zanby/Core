 ...
 */
class Warecorp_Mail_Template_Import 
{
    private $_xml;
    ...
    private static function getStringValue($path)
    {
        if (!isset($path[0]) ) {
     ...
     * @return boolean
     */
    private static function nodeExists($items)
    {
     ...
     * @return string
     */
    private static function getAttribute($dom, $attrName)
    {
        $attr = $dom->attributes();
