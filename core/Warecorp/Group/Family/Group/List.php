 ...
 */
class Warecorp_Group_Family_Group_List extends Warecorp_Abstract_List
{
	/**
	 * group id
	 */
	...
	private static $usersGroups = array(); // ассоциативные массивы групп, в которых пользователь хост
