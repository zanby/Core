 ...
 */
class Warecorp_Group_Invitation_eHeaders
{
	const GROUP_NAME        = 1;
	const CREATION_DATE     = 2;
    const STATUS            = 3;
	const INVITATION_NAME   = 4;
	private static $allowedFields = array('name', 'creation_date', 'status', 'subject');
	private static $allowedHeaders = array('group_name', 'creation_date', 'status', 'subject');
