 ...
 *
 */
class Warecorp_ICal_Event_List
{
	private $DbConn;
    ...
    private static $eventsCache = array();          // РєРµС€ РѕР±СЉРµРєС‚РѕРІ СЃРѕР±С‹С‚РёР№, СЃРѕР·РґР°РЅРЅС‹С… С„СѓРЅРєС†РёРµР№ self::createEvent
    private static $eventsExdateCache = array();    // РєРµС€ exdat РґР»СЏ СЃРѕР±С‹С‚РёР№
    private static $eventsDatesCache = array();     // РєРµС€ РґР°С‚ РґР»СЏ СЃРѕР±С‹С‚РёСЏ РІ РѕРїСЂРµРґРµР»РµРЅРЅРѕР№ С‚Р°Р№РјР·РѕРЅРµ Рё РІСЂРµРјРµРЅРЅРѕРј РёРЅС‚РµСЂРІР°Р»Рµ, С…СЂР°РЅРёС‚СЊ master-array

    private static $usedEventsIds = array();        // ids СЃРѕР±С‹С‚РёР№, РєРѕС‚РѕСЂС‹Рµ Р±С‹Р»Рё РѕР±СЂР°Р±РѕС‚Р°РЅРЅС‹ РІ СЂРµР·СѓР»СЊС‚Р°С‚Рµ РѕРґРЅРѕРіРѕ РІС‹Р·РѕРІР° С„СѓРЅРєС†РёРё buildRecurList
    ...
    */
    public function findEvent($objEvent, $eventId, $eventUid, $year, $month, $day)
    {
        ...
        $objStartDate->setTime($objEvent->getDtstart());
