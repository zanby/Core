...
*/
class Warecorp_Video_AccessManager_Factory {
    /**
    ...
    static public function create($context = null)
    {
        ...
        switch ( $context ) {
            case 'product'          : return Warecorp_Video_AccessManager_ESA::getInctance();
            case 'product-ei'       : return Warecorp_Video_AccessManager_EIA::getInctance();
            case 'zanby-product'    : return Warecorp_Video_AccessManager_ESA::getInctance();
            case 'zanby-product-ei' : return Warecorp_Video_AccessManager_EIA::getInctance();
            case 'zanby'            : return Warecorp_Video_AccessManager_ESA::getInctance();
            case 'at'               : return Warecorp_Video_AccessManager_ESA::getInctance();
            case 'cd'               : return Warecorp_Video_AccessManager_ESA::getInctance();
            	...
            	try {
	                ...
	                if ( defined('IMPLEMENTATION_TYPE') ) {
	                    if ( 'ESA' == IMPLEMENTATION_TYPE )
                            return Warecorp_Video_AccessManager_ESA::getInctance();
	                    else
