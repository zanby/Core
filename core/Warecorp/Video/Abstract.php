 ...
 * @version 1.0
 */
abstract class Warecorp_Video_Abstract extends Warecorp_Data_Entity implements Warecorp_Global_iSearchFields
{
    ...
    public function getViewerSrc()
    {
        if ( !empty($this->customSrc)) {
            ...
            return UPLOAD_BASE_URL.'/swfmediaplayer/mediaplayer.swf';
        }           
    }
