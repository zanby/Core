...
class Warecorp_Search_KeywordsParser
{
    private static $searchPrefixArray = array('country', 'state', 'city', 'tag', 'category', 'age', 'where', 'when', 'list_type');
    ...
    private static function clearSingleQuote ($input) {
    ...
    private static function isStringQuoted($string)
    {
