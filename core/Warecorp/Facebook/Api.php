...
*/
class Warecorp_Facebook_Api {
	private static $_instance;

    private static $_facebookId;
	
	public static function getInstance()
	{
		if ( null === self::$_instance ) {
			
			if ( !defined('FACEBOOK_API_KEY') || !defined('FACEBOOK_API_SECRET') ) throw new Exception('Incorrect facebook application configuration');
            require_once 'facebook.php'; 
			self::$_instance = new Facebook(array('appId'=>FACEBOOK_API_KEY, 'secret'=>FACEBOOK_API_SECRET, 'cookie'=>true));
		}
