 ...
 */
class Warecorp_Cache_MemCacheManager
{
    ...
    */
    private function getConnectionByRageId($id)
    {
    ...
    */
    private function getConnectionObjectByRageId($id)
    {
        $lastName = $this->getServerNameById($id);
    ...
    */    
    ...
    {
        $serverName = $this->getConnectionObjectByRageId(Warecorp_Cache_MemCacheManager::getHash($id))->getName();
        $this->getConnectionObjectByRageId(Warecorp_Cache_MemCacheManager::getHash($id))->setActive(false);
        foreach ($this->_pointsServers as $range => $name)
        {
...
//        /var_dump($this->_prefix.'_'.$id); 
    ...
    */    
    ...
    {    
        ...
        if (($this->getConnectionByRageId(Warecorp_Cache_MemCacheManager::getHash($id)) === null) 
                || !$result = @$this->getConnectionByRageId(Warecorp_Cache_MemCacheManager::getHash($id))->save($data, $id, $tags , $specificLifetime)) 
        {
            $this->removeServerFromQueueByCacheId($id);    
            $result = $this->save($data, $id, $tags, $specificLifetime);        
        }   
        return $result;
    } 
    ...
    */    
    ...
    {
            $id = $this->addContext($id); 
            $result = $this->getConnectionByRageId(Warecorp_Cache_MemCacheManager::getHash($id))->load($id);   
            return $result;
    } 
    ...
    */    
    ...
    {
        $id = $this->addContext($id); 
        return $this->getConnectionByRageId(Warecorp_Cache_MemCacheManager::getHash($id))->remove($id);
    } 
    ...
    */    
    ...
    {
        $id = $this->addContext($id); 
        return $this->getConnectionByRageId(Warecorp_Cache_MemCacheManager::getHash($id))->test($id);
    } 
