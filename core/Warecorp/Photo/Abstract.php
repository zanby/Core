...
*/
   ...
   * @version 1.0
   */
abstract class Warecorp_Photo_Abstract extends Warecorp_Data_Entity_Image implements Warecorp_Global_iSearchFields
{
	/**
	 * table name
	 */
	...
	private static $_maxPreviewWidth = 800;
	private static $_maxPreviewHeight = 600;
	/**
	 * id of photo
	 */
	private $id;
