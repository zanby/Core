 ...
 */
class Warecorp_DiscussionServer_GroupSubscription
{
    private $db;
    private $id = null;
    private $userId;
     ...
     */
    private static function enqueuePostForDeliveryInGroup($subscriptionMessage, $groupSubscriptionId)
    {
        $messageDb = Zend_Registry::get("messageDB");
     ...
     */
    private static function deliverEnqueuedMessages($subscriptionData)
    {
     ...
     * @return bool
     */
    private static function chekDeliveryAllowed($groupId)
    {
        //check if group allows delivering messages via email
     ...
     */
    private static function cleanupFreeMessages()
    {
        $messageDb = Zend_Registry::get("messageDB");
