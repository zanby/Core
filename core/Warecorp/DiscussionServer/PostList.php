 ...
 */
class Warecorp_DiscussionServer_PostList
{
    ...
    private static $cacheCountUnreadByTopicId;
    private static $cacheCountByTopicId;
    private static $cacheCountAuthorsByTopicId;
    private static $cacheCountByTopicIdAndDate;
